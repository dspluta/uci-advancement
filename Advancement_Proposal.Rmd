...
influences on a particular observed trait. In genome-wide association studies (GWAS), the
...
In our previous work, we have applied the adaptive Mantel test to analyze data from 350 healthy college students from Beijing Normal University who participated in a visual working memory task, during which 64-channel EEG was recorded at 1 kHz (Figure 1).  The total duration of the experiment was approximately 10 minutes for each subject.  Approximately $5 \times 10^5$ SNPs were also measured for each subject. Standard pre-processing and quality control steps were applied to both the EEG and genetic data.  We are interested in testing the association of alpha and theta band coherence with a group of 11 SNPs that have been identified as potentially related to Alzheimer's Disease.  
...
## Aim 1: Global Association Testing Methods for Imaging Genetics Data

### Aim 1.1: Development of the Adaptive Mantel Test
